...
import { FaTrophy, FaEdit, FaTrash, FaUserPlus, FaShieldAlt, FaHistory, FaCrown } from 'react-icons/fa';
                  ...
                  {championship.titleHistory && championship.titleHistory.length > 0 && (
                    <div className="mt-4">
                      ...
                      <div className="timeline-container">
                        {championship.titleHistory.reverse().map((reign, index) => (
...
export default ChampionshipDetail;err) {
